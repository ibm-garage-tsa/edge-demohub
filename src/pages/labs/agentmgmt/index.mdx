...
## Summary
  ...
  Congratulations! You have successfully completed the lab "Installing IBM Edge Application Manager agent”. Follow the [Service management tutorial](https://ibm-garage-tsa.github.io/edge-demohub/labs/svcmgmt/) to learn more.
