...
***
  ...
  ![email-device](images/2020-12-09-10-36-51.png)

  - Management hub reservation e-mail

  ![email-hub](images/2020-12-09-10-36-51.png)
...
## Accessing the IBM Edge Application Manager instance
  ...
  ![email-hub](images/2020-12-10-16-42-03.png)
...
## Accessing and starting a simulated edge device
  ...
  ![](images/2020-12-09-11-20-00.png)

  Click **Access Trial** button (it should open a browser) and when prompted for Virtual machine access, provide the **Desktop password** from the e-mail.

  ![virtual_machine_access](images/2020-12-09-13-06-52.png)
...
## Accessing the virtual edge device desktop
  ...
  ![](images/2020-12-09-13-15-49.png)

  You should see the following screen

  ![](images/2020-12-09-13-16-11.png)

  Click on the screen or hit enter key, then select the **ibmuser**. You can type in password **passw0rd!** or insert the stored credentials as shown below

  ![](images/2020-12-09-13-17-51.png)
