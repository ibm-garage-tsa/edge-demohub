...
***
  ...
  - Edge trial reservation e-mail

  ![](images/2021-02-02-12-40-56.png)

## Accessing the IBM Edge Application Manager instance

  In the email confirming the Management hub reservation, there is a link to the Management hub and your access credentials.

  ![](images/2021-02-02-12-42-09.png)
...
## Accessing and starting a simulated edge device
  ...
  ![](images/2021-02-02-12-43-28.png)
  ...
  for example:
  ```
  ssh ssh 270xx4w3qr@169.47.95.9
  ```
