...
***
  ...
  To follow the instruction yoiu need the IBM Edge Application Manager Trial environment. To provision one, follow the instructions: [Requesting the Trial](../environment/requesting/index.mdx)
...
## Accessing the virtual edge device desktop
  ...
  In can you would like to access the desktop of the provided virtual machine, follow the instructions below.
